...
// Pastikan CSRF token tersedia untuk form state-changing
                        ...
                        <div class="header__top__right__language">
                            <?php if (
                              ...
                              $_SESSION["role"] === "customer"
                                ...
                                <div><i class="fa fa-user"></i> <?= htmlspecialchars(
                                  $_SESSION["username"],
                                ) ?></div>
            ...
            <div class="col-lg-6">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li <?php if (basename($_SERVER["PHP_SELF"]) === "shop-grid.php") {
                          echo 'class="active"';
                        } ?>><a href="./shop-grid.php">Shop</a></li>
                        <li <?php if (basename($_SERVER["PHP_SELF"]) === "contact.php") {
                          echo 'class="active"';
                        } ?>><a href="./contact.php">Contact</a></li>
                        <li <?php if (basename($_SERVER["PHP_SELF"]) === "order-history.php") {
                          echo 'class="active"';
                        } ?>><a href="./order-history.php">Orders</a></li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3">
